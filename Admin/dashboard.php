                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav flex-column " id="deptDropdown" style="display: none;">
                                <li class="nav-item ">
                                    <a href="#" class="nav-link text-secondary">- Add Department</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link text-secondary">- Manage Department</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="nav flex-column " id="EmpDropdown" style="display: none;">
                                <li class="nav-item ">
                                    <a href="#" class="nav-link text-secondary">- Add Employees</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link text-secondary">- Manage Employees</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="nav flex-column " id="levDropdown" style="display: none;">
                                <li class="nav-item ">
                                    <a href="#" class="nav-link text-secondary">- Add Leave Type</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link text-secondary">- Manage Leave Type</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
